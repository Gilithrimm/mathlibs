...
class MyMathTest {
	...
	void getProduct_forEmptySequence() {
		...
		int actual = (int) getProduct(seq);
		assertEquals(1, actual);
	}
	@Test
	void getProduct_forPowersFrom1To10(){
		Sequence seq=new Sequence(1,10,POW);
		long actual=getProduct(seq);
	...
	@Test
	void getAverage_forPowersFrom1To10() {
		Sequence sequence=new Sequence(1,10,POW);
		long actual=getAverage(sequence);
	...
	@Test
	void getMedian_forEvenLength(){
		Sequence seq=new Sequence(1,10,POW);
		long actual=getMedian(seq);
		assertEquals(30L,actual);
	}
	@Test
	void getMedian_forOddLength(){
		Sequence seq=new Sequence(0,10,POW);
		long median = getMedian(seq);
	...
	@Test
	void getMode_forEvenlyCommonNumbers(){
		Sequence seq=new Sequence(1,10,POW);
		int mode = getMode(seq);
		assertEquals(1,mode);//1st element of a seq
	}
	@Test
	void getMode_forMostCommonNumber(){
